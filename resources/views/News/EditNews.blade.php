    ...
    <div class="bg-secondary rounded h-100 p-4">
        ...
        <form action="{{ route('News.update') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="text" name="title" placeholder="title" value="{{ $News->title }}" class="form-control" id="inputEmail3">
                </div>
            </div>
            <div class="row mb-3">
                <label for="inputEmail3" class="col-sm-2 col-form-label">المحتوي</label>
                <div class="col-sm-10">
                    <textarea id="summernote"  value="{{ $News->content }}" name="content" placeholder="content" class="form-control"></textarea>
                </div>
            </div>
            <div class="row mb-3">
                <label for="inputEmail3" class="col-sm-2 col-form-label">الكلمات الداله</label>
                <div class="col-sm-10">
                    <input type="text" name="keyWords" placeholder="keyWords" value="{{ $News->keyWords }}" class="form-control" id="inputEmail3">
                </div>
            </div>

            <div class="row mb-3">
                <label for="inputPassword3" class="col-sm-2 col-form-label">وقت القرائه</label>
                <div class="col-sm-10">
                    <input  type="text" name="timeReading" placeholder="timeReading" value="{{ $News->timeReading }}" class="form-control" id="inputPassword3">
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="file" name="image_path" placeholder="image_path" value="{{ $News->image_path }}" class="form-control bg-dark" id="formFile">
                </div>
            </div>
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <select id="category" name="categoryID"  placeholder="category" class="form-select mb-3" aria-label="Default select example">
                        <option value="" disabled selected>اختارالعنوان الرئيسي</option>
