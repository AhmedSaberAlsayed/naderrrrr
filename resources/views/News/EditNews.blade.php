    ...
    <div class="bg-secondary rounded h-100 p-4">
        ...
        <form action="{{ route('News.store') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="text" name="content" placeholder="content" value="{{ $News->content }}" class="form-control" id="inputEmail3">
                </div>
            </div>
            <div class="row mb-3">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="text" name="createdBy" placeholder="createdBy" value="{{ $News->createdBy }}" class="form-control" id="inputPassword3">
                </div>
            </div>
            <div class="row mb-3">
